...
<ul class="accordion" data-role="accordion">
        <li>
            ...
            <div>
            <iframe name="iMyProduct" src="mywishlist.php" frameborder="0" style="height:1200px; width:100%;"></iframe>
            </div>
        </li>
        ...
        <li>
            <a href="#"> Wishlist </a>
            <div>
            <iframe name="iMyProduct" src="newsearchwish.php" frameborder="0" style="height:1200px; width:100%;"></iframe>
            </div>
        </li>
</ul>
</body>
