...
function getName(value){
	$.post("searchwish5.php",{partialProductName:value},
...
function getByType(value1,value2)
{
	if(value1!="")
	{
   		$.post("searchwish6.php",{partialProductName:value1,ptype:value2},
	...
	{
		$.post("searchwish7.php",{ptype:value2},
...
<table width="100%">
  <tr>
    ...
    <input type="text" id="searchText" name="searchText" onkeyup="getName(this.value)" placeholder="Wishlist Name">
