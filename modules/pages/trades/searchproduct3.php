...
$ptype = $_POST['ptype'];
$rawtrades = mysql_query("SELECT t.* FROM trades t WHERE t.status=1
						                             AND t.ttype='$ptype'
						                             AND t.ttitle LIKE '%$searchP%' ORDER BY t.tdate DESC") or die(mysql_error());
?>
</head>
...
<tr>
    ...
    <div style="width:100px; height:100px; overflow:hidden">
		<a class="fancybox" rel="group" href="files/<?php echo $trades['tpic']; ?>">
			<img style="max-width:100px ; height:auto" src="files/<?php echo $trades['tpic']; ?>">a
		</a>
    </div>
    </td>
