<?php
//DEFAULT web Mosque ID:
$defaultmID = 100;
//
	$uWeb_chardb[uid] = 0;
	
	$cookienameID = "pinbDBuseru";
	$cookienameName = "pinbDBusern";
	$cookieAuthID = $_COOKIE[$cookienameID];
	$cookieAuthName = $_COOKIE[$cookienameName];
	$serverUp = 0;
	...
	//$DB_PASS = "ftmk";
	$DB_HOST = "localhost";
	$DB_NAME = "marhazk_pinnew";
	$DB_USER = "marhazk_pinnew";
	$DB_PASS = "Missida890";
