...
<input type="hidden" id="myLocation"  />
  ...
  <div id='PinItMap' style="position:relative;width:70%; height:480px;float:left"></div>
  <div id="directionsItinerary" style="width:30%;height:480px;float:right; overflow-y:scroll"></div>
</body>
</html>