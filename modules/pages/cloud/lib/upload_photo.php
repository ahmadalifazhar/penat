    ...
    <p>Pick up a file to upload, and press &quot;upload&quot;:</p>
     ...
     <fieldset style="margin-top:0px">
       ...
       <div class="input-control select span3" style="margin-top:20px"><label>Select folder: </label>
                                    <?php
                                    $q = "SELECT folder_id, name FROM folder WHERE (owner = '".$userunq."' OR owner = 'def') AND type = 2";
			  ...
			  echo '  <option value="'.$data[folder_id].'">'.$data[name].'</option>';
				...
				?></select>
       							...
       							<label class="input-control checkbox">
                                    <input type="checkbox" name="pin_status" checked="" value="1">
                                    <span class="helper">Pin your thoughts...</span>
                                </label><br/>
                                <div class="input-control text">
                                    <input type="text" name="pin_status_text"/>
                                    <button class="btn-clear"></button>
                                </div>
       <br/>
                                <label class="input-control checkbox">
                                    <input type="checkbox" name="pin_location" checked="" value="1">
                                    <span class="helper">Pin your locations...</span>
                                </label>
                              
     </fieldset>
     <center><input style="margin-top:10px" type="submit" name="Submit" value="upload" /></center>
     <br/>
        <div class="progress">
        <div class="bar"></div >
