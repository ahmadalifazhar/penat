...
<body class="metrouicss">
  <fieldset>
    ...
    <form id="form1" name="form1" enctype="multipart/form-data" method="post" action="?op=cloud&go=upload_lib_entertainment" >
    <p>
              
      <textarea style="width:100%; height:100px; resize:none" name="status" id="textarea" placeholder="Pin anything..."></textarea>
      </p>
      <p>Pick up an video file to upload, and press &quot;upload&quot;:</p>
      <p>
