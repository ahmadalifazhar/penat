...
<iframe onload="iFrameHeight()" style="margin-left:-5px;" id="blockrandom" name="" src="http://live.rtm.gov.my/filtering/tv2.php" width="670" height="420" scrolling="no" frameborder="0" class="wrapper">
	No Iframes</iframe>
...
$detail[ptext] = "is watching RTM 2 Live Streaming via Pin-IT Entertainment";
