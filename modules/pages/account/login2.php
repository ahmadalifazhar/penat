...
<head>
<title>Pin.it 2013 - User Login</title>
...
<div class="gridContainer clearfix" >
  <div class="contain_baru">
    <div class="baru" align="center"><a href="?op=home"><img src="images/white.png" width="250" height="100" /></a></div>
  </div>
...
border-radius: 7px; " class="metrouicss" onload="prettyPrint()">
 <h2 style="color:whitesmoke; text-align:left; text-shadow:
    ...
    .5px -.5px 0 #000,
    -.5px .5px 0 #000,
    .5px .5px 0 #000;">User Login</h2>
<form name="form1" method="post" action="" >
  <div class="input-control text">
<input type="text" name="auname" id="auname" placeholder="Username"/>
<button class="btn-clear"></button>
  ...
  <p style="text-align:left">
    <input type="submit" name="opchk" id="opchk" value="Login">
  </p>
</form>
  </div>
  <p>&nbsp;</p>
