...
var pushpinUserLocation = {icon:'images/userLoc.png',width: 100, height: 100}; //image for current user location indicator
var pushpinSearchLocation = {icon:'images/xxx.png',width: 50, height: 50}; //image for current user location indicator
