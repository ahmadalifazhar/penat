...
//try to get coordinate on start
function getCenternw()
{
	Microsoft.Maps.loadModule('Microsoft.Maps.Themes.BingTheme', { callback: function() { 
	var latlon = map.getCenter();
	currentLat = latlon.latitude;
...
//function utk tunjuk location dlm textbox (alif)
 function displayEventInfo(e) {
	...
	document.getElementById("latid").value = currentLat;
	document.getElementById("lonid").value = currentLon;
