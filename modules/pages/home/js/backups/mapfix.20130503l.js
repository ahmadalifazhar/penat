...
var pushpinUserLocation = {icon:'images/userLoc.png',width: 50, height: 50}; //image for current user location indicator
var pushpinSearchLocation = {icon:'...saje buang dulu ...images/xxx.png',width: 50, height: 50}; //image for current user location indicator
