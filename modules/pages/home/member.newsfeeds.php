...
$cmt = false;
	foreach($newDB as $newsfeedr)
	{
		...
		if (($newsfeedr[pcat] >= 500) && ($newsfeedr[pcat] < 600)) //Chat
			...
			$bgcolor = "teal";
		else if (($newsfeedr[pcat] >= 1200) && ($newsfeedr[pcat] < 1300)) //entertainment
			$bgcolor = "pink";
			...
			$bgcolor = "greenLight";
		else if (($newsfeedr[pcat] >= 1700) && ($newsfeedr[pcat] < 1800)) //shopping
			$bgcolor = "blue";
...
//			$newsfeedr['ptext'] = str_replace("\n", "<BR>", $temptext);
   ...
   word-wrap: break-word;      /* IE */
    ...
    <b class="sticker sticker-left sticker-color-<?php echo $bgcolor;?>"></b>
        	...
        	<div class="reply">
        	<div class="date"><a href="#" class="pintime" style="color:#FFF;font-size:9px;" onClick="gotoLocation(<?php echo $newsfeedr[lat];?>,<?php echo $newsfeedr[lon];?>);displayInfobox();"><img src="/images/<?php echo isonline($newsfeedr);?>.gif"> <?php echo pintime($newsfeedr);?></a></div>
...
//			$commentr['ptext'] = str_replace("\n", "", $temptext);
 ...
 <div class="replies" style="margin-left:15px;margin-top:-8px">
	<div class="bg-color-<?php echo $bgcolor;?>" style="width:444px;">
        ...
        <div class="reply">
        	<div class="date"><div class="pintime" style="color:#FFF;font-size:9px;"><img src="/images/<?php echo isonline($commentr);?>.gif"> <?php echo pintime($commentr);?></div></div>
