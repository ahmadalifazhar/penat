...
<H3 style="margin-top:14px;" align="center">General Account Settings</H3>
 ...
 <table class="bordered" style="margin-top:10px;">
      ...
      <input type="reset" value="Reset" name="B2" style="margin-right:0px;">
        ...
        <input type="text" style="width:300px;margin-bottom:5px;" value="_current_user_name_"><input type="submit" value="Change" name="opchk" style="margin-left:265px;margin-bottom:0px;margin-right:0px;">
    	</div>
</form>	</td>
        </tr>
        ...
        <div class="input-control text">
        <input type="text" style="width:300px;margin-bottom:5px;" value="_current_first_name_"><input type="submit" value="Change" name="opchk" style="margin-left:265px;margin-bottom:0px;margin-right:0px;">
    	</div>
</form>	</td>
        </tr>
        ...
        <div class="input-control text">
        <input type="text" style="width:300px;margin-bottom:5px;" value="_current_last_name_"><input type="submit" value="Change" name="opchk" style="margin-left:265px;margin-bottom:0px;margin-right:0px;">
    	</div>
</form>	</td>
        </tr>
        ...
        <H4>Here we in Pin-It team suggest you to change the password every 2-4 months. This will increase the security of your account and prevent future social intrusion. To gain your confidence with us we have implemented all appropriate measures to provide the maximum amount of protection to our client.
        ...
        <H4>By turning on the privacy control, this could enhance the security of your profile by limitating your activity by your connected friends only. In this case your activity cannot be seen by other persons / unknown user. [Haz gay]</H4>
        <div>
