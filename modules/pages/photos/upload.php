<?php
	...
	if ($_POST[upload] == 1)
	{
		...
		$uWeb_gfxtime = time();
		$uWeb_gfx2q = "INSERT INTO photos (pby, pname, pfile, pdate, mID, porifile, poritype, pdesc) values ($chkid, '".$_POST[title]."', '$eubo_temp_c', '".$uWeb_gfxtime."', '".$_POST[cat]."', '".$_FILES['gfx']['name']."', '".$_FILES['gfx']['type']."', '$gfx_desc');";
		...
		echo "<font color=green><BR>Gambar anda telah dimuatnaikkan. Sila <a href=\"?op=photos/view&cat=".$_POST[cat]."&name=".$eubo_temp_c."\">klik disini</a> untuk paparkan gambar.<br><BR></font>";

	}
	include "modules/photos/upload.design.php";
?>
