...
function uploadpic($_POST)
{
	...
	if ($_POST[upload] == 1)
	{
		...
		$detail[file] = $eubo_temp_c;
		$detail[filename] = $eubo_temp_c;
		$detail[pdate] = $uWeb_gfxtime;
		$detail[porifile]	= $_FILES['gfx']['name'];
		$detail[poritype]	= $_FILES['gfx']['type'];
		$detail[success] = 1;
